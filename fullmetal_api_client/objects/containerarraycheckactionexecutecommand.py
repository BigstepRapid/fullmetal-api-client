...
class ContainerArrayCheckActionExecuteCommand(object):
	"""
	ContainerArrayCheck action that executes a command on the Containers to
	asses their readiness or liveness.
	"""
